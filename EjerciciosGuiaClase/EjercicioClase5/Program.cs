...
namespace EjercicioClase5
{
    class Program
    {
        ...
        {
            #region TEORIA IMPORTANTE
            /*object.referenceEquals(var1,var2)compara si la referencia es null
            EJEMPLO:
            if(!object.referenceEquals(m2,null"))
             * {
             *      Console.WriteLine("Si la referencia del objeto no es nulo, entra.");
             * }
             * 
             * EL PROBLEMA EN EL CODIGO es en el ==(Estante e, Producto p) ya que el estante viene nullo
            */
            #endregion
